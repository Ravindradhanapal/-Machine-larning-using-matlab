...
data = readtable('/Users/ravindrakumardhanapal/Desktop/MLCode/d1/ICA/Gear1.xlsx');  
...
data = table(Var1, Var2, Var3, Var4, Var5, Var6, Var7, Var8, Var9, Var10,Var11, Var12, Var13, Var14, Var15, Var16, Var17, Var18, Var19, Var20,Var21, Var22, Var23, Var24, Var25, Var26, Var27, Var28, Var29, Var30,Var31, Var32, Var33, Var34, Var35, Var36, Var37, Var38, Var39, Var40,Var41, Var42, Var43, Var44, Var45, Var46, Var47, Var48, Var49,Var50 ,Var51, Var52, Var53, Var54, Var55, Var56, Var57, Var58, Var59, Var60,Var61, Var62, Var63, Var64, Var65, Var66, Var67, Var68, Var69, Var70,Var71, Var72, Var73, Var74, Var75, Var76, Var77, Var78, Var79, Var80,Var81, Var82, Var83, Var84, Var85, Var86, Var87, Var88, Var89, Var90,Var91, Var92, Var93, Var94, Var95, Var96, Var97, Var98, Var99, Var100,Var101, Var102, Var104, Var105, Var106, Var107, Var108, Var109, Var100,Var111, Var112, Var113, Var114, Var115, Var116, Var117, Var118, Var119,Var120, class_labels);
%
% data = table(Var1, Var2, Var3, Var4, Var5, Var6, Var7, Var8, Var9, Var10, Var11, Var12, Var13, Var14, Var15, Var16, Var17, Var18, Var19, Var20, Var21, Var22, Var23, Var24, Var25, Var26, Var27, Var28, Var29, Var30, Var31, Var32, Var33, Var34, Var35, Var36, Var37, Var38, Var39, Var40, Var41, Var42, Var43, Var44, Var45, Var46, Var47, Var48, Var49, Var50, Var51, Var52, Var53, Var54, Var55, Var56, Var57, Var58, Var59, Var60, Var61, Var62, Var63, Var64, Var65, Var66, Var67, Var68, Var69, Var70, Var71, Var72, Var73, Var74, Var75, Var76, Var77, Var78, Var79, Var80, Var81, Var82, Var83, Var84, Var85, Var86, Var87, Var88, Var89, Var90, Var91, Var92, Var93, Var94, Var95, Var96, Var97, Var98, Var99, Var100, class_labels);
% data1 = [Var1, Var2, Var3];
% c = cov(data' * data);
% e = eig(c);
% e1 = (sort(e(:), 'descend' ));
% 
% Variability = (sum (e1(3,1))) / (sum (e1(:,1)));

%% -------------- Building Classifier ----------------------------


classification_model = fitcensemble(data,'class_labels');
...
% 
% %Results = confusionmat(table2cell(data(:,end)), Predictions);
% Evaluation_results1 = confusionmatStats((data.class_labels),Predictions);
% 
% 
% A1FMeasure = mean(Evaluation_results1.Fscore);
% 
% A2Accuracy = mean(Evaluation_results1.accuracy);
% 
% A3Sensitivity = mean(Evaluation_results1.sensitivity);
% 
% A4Specificity = mean(Evaluation_results1.specificity);

% 
% A1FMeasure = mean(Evaluation_results.Fscore);
% A11Accuracy = mean(Evaluation_results.accuracy);
% A111Sensitivity = mean(Evaluation_results.sensitivity);
% A1111Specificity = mean(Evaluation_results.specificity);
% ---------------------------- Code ---------------------------
% 
...
% classifier_name = 'k-Nearest Neighbor [k-NN](Training Results)';
...
% Y1 = ismember(training_data.class_labels,labels(1:end-18));
...
%  
% labels = unique(data.class_labels);
% classifier_name = 'k-Nearest Neighbor [k-NN](Testing Results)';
...
% Y1 = ismember(testing_data.class_labels,labels(1:end-18));
...
% scatter(testing_data.Var1(~Y1),testing_data.Var2(~Y1) , 'o' , 'MarkerEdgeColor', 'black', 'MarkerFaceColor', 'green');
